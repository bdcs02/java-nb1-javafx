...
public class Candlestick {
     ...
     * Get the bid
     * <p>
     * The candlestick grafikus.foci.data based on bids. Only provided if bid-based candles
     * were requested.
     * <p>
     * @return the bid
     * @see CandlestickData
     ...
     * Get the ask
     * <p>
     * The candlestick grafikus.foci.data based on asks. Only provided if ask-based candles
     * were requested.
     * <p>
     * @return the ask
     * @see CandlestickData
     ...
     * Get the mid
     * <p>
     * The candlestick grafikus.foci.data based on midpoints. Only provided if midpoint-based
